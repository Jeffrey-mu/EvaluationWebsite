    ...
    watch: {
      searchKeys(value, old) {
        ...
        document.querySelector(SEARCH_RESULT).innerHTML = this.successSearchResult.map((item, index) => `
            ...
            <a href="${item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + this.type : './detailsReviews.html?id=' + item.id + '&type=' + this.type}" class="article_item" style="padding-bottom: 20px;margin-top: 20px; border-bottom: 1px solid #ccc; display: inline-block;width: 100%">
                <img class="image_2" style="width: 100%;" referrerpolicy="no-referrer"
...
<svg t="1675150151577" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1490" width="23" height="23"><path d="M982.028557 404.405174 573.32303 83.942886c-34.918864-27.694272-89.619352-27.694272-124.538216 0L43.175542 404.577188c-13.933143 11.008903-16.169326 31.134554-5.332437 44.895683s31.134554 16.169326 44.895683 5.332437l13.073072-10.320847 0 387.547791c0 54.872501 56.936671 95.983874 107.852847 95.983874l639.892491 0c50.22812 0 84.1149-38.531161 84.1149-95.983874L927.672098 443.452377l14.449185 11.352931c5.84848 4.644381 12.729044 6.880564 19.781623 6.880564 9.460776 0 18.921552-4.128339 25.286074-12.213002C998.369898 435.539728 995.789686 415.414077 982.028557 404.405174zM607.897867 797.113388l0 66.741475-63.989249 0-63.989249 0-63.989249 0 0-66.741475 0-112.325214c0-37.155048 30.102469-77.234336 95.983874-77.234336 66.053418 0 95.983874 40.079288 95.983874 77.234336L607.897867 797.113388 607.897867 797.113388z" fill="#ffffff" p-id="1491"></path></svg>
          ...
          <div class="block_1_item flex-col" v-for="item in menu">
            ...
            item.id == '19' ? './reviewsPage.html?id=' + item.type + '-' + item.id + '-' + 1 + '&type=' + type : './channelPage.html?id=' + item.type + '-' + item.id + '-' + 1 + '&type=' + type" class="text_6">{{item.name}}</a>
          </div>
        </div>
      </div>
    </div>`
  ...
  renderElement(TOP_RECOMMENDATION, {
    ...
    flex: 1;"> <a :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type" class="active_null" v-for="item in topRecommendation">
          <span class="text_13">{{item.topping_title}}</span></a></div>
      </div>`
  })
              ...
              <div class="recommended_by_the_author">
                <div class="recommended_by_left">
                  ...
                  <div class="author_article_list">
                    <a :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type" class="author_article_list_item" v-for="item in details_info.category_recommend_list">
                ...
                <div class="recommended_by_right">
                  ...
                  <div class="author_article_list">
                    <a :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type" class="author_article_list_item" v-for="item in details_info.newest_recommend">
                      <img
                        :src="item.first_picture"
                        alt="">
                      <a class="text_21">{{item.title}}►</a>
            ...
            <div class="post">
              <div class="top">
                ...
                <div class="right_flex">
                  <p class="text_21">SIGN UP FOR EMAIL {{menu.find(item => item.id == details_info.two_type).name.toLocaleUpperCase()}}</p>
                </div>
...
`
    ...
    template: ` <div class="typePage reviewsPage">
        <div class="left">
          <div class="typePage_top_content animate__animated animate__fadeIn">
            ...
            <div class="right">
              <a :href="'./detailsReviews.html?id=' + item.id + '&type=' + type" class="right_item" v-for="item in channelResult.slice(1, 4)">
                <img class="image_2" referrerpolicy="no-referrer"
                  :src="item.first_picture" />
          ...
          <div class="article_block">
            ...
            <div class="article_list">
              <a :href="'./detailsReviews.html?id=' + item.id + '&type=' + type" class="article_item" v-for="item in channelResult.slice(4)">
                <img class="image_2" referrerpolicy="no-referrer"
                  :src="item.first_picture" />
                <div class="article_item_text-group_1">
                  <div class="text_21">
  ...
  renderElement(BESTPICKS_PAGE, {
    ...
    methods: {
      ...
      handleNextPage() {
        window.location.href = "./bestpicksPage.html?id=" + this.id + this.page + '&type=' + this.type
      }
    },
    async mounted() {
      let search = window.location.search.slice(1)
    ...
    template: `<div class="typePage bestpicksPage animate__animated animate__fadeIn">
        <div class="left">
          <div class="typePage_top_content">
            ...
            <div class="right">
              <a :href="'./detailsBestpicks.html?id=' + item.id + '&type=' + type" class="right_item" v-for="item in channelResult.slice(1, 4)">
                <img class="image_2" referrerpolicy="no-referrer"
                  :src="item.first_picture" />
                <div class="right_item_text-group_1 flex-col ">
                  <h2 class="text_24">
          ...
          <div class="article_block">
            ...
            <div class="article_list">
             <a :href="'./detailsBestpicks.html?id=' + item.id + '&type=' + type" class="article_item" v-for="item in channelResult.slice(4)">
                <img class="image_2" referrerpolicy="no-referrer"
                  :src="item.first_picture" />
                <div class="article_item_text-group_1">
                  <div class="text_21">
  ...
  <div class="left">
    ...
    <div class="typePage_top_content">
      <a :href="channelResult[0].type == 1 ? './detailsBestpicks.html?id=' + channelResult[0].id + '&type=' + type : './detailsReviews.html?id=' + channelResult[0].id + '&type=' + type"
        class="left">
...
`
  ...
  renderElement(AUTHOR_CONTENT, {
    ...
    methods: {
      ...
      handleNextPage() {
        window.location.href = "./author.html?id=" + this.id + this.page + '&type=' + this.type
      }
    },
        ...
        <div class="left">
          ...
          <div class="article_block">
            ...
            <div class="article_list">
              ...
              <a :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type" class="article_item" v-for="item in authorResult.article_list">
                <img class="image_2" referrerpolicy="no-referrer"
                  :src="item.first_picture" />
                <div class="article_item_text-group_1">
                  <div class="text_21">
            ...
            <div class="article_limit_page">
              <span v-for="item in total">
                <a :class="{active: item == page-1}" :href="'./author.html?id=' + id + item + '&type=' + type">{{item}}</a>
              </span>
              <span @click="handleNextPage">Next Page</span>
            </div>
          </div>
...
`
  ...
  renderElement(INDEX_CONTENT, {
    ...
    template: `<div class="typePage index_content">
  <div class="top_content">
    <div class="read_more index_title">
      <span>Latest</span>
      <span class="bottom_border"></span>
    </div>
    <a class="right" :href="indexResult.newest_list[0].type == 1 ? './detailsBestpicks.html?id=' + indexResult.newest_list[0].id + '&type=' + type : './detailsReviews.html?id=' + indexResult.newest_list[0].id + '&type=' + type">
    ...
    <div class="left">
      <template v-for="item, index in indexResult.newest_list.slice(1, 3)">
        <a class="left_item" :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type">
  ...
  <div class="bottom">
    <a class="bottom_item" v-for="item in indexResult.newest_list.slice(3, 7)" :href="item.type == 1 ? './detailsBestpicks.html?id=' + item.id + '&type=' + type : './detailsReviews.html?id=' + item.id + '&type=' + type">
      <img class="image_2" referrerpolicy="no-referrer" :src="item.first_picture" />
  ...
  <div class="read_more">
    ...
    <span class="bottom_border"></span>
    <a :href="'./bestpicksPage.html?id=1-18-1' + '&type=' + type"><span>view more▶</span></a>
  </div>
  <div class="top_content best_picks">
    <a class="right" :href="'detailsBestpicks.html?id=' + indexResult.newest_best_picks_list[0].id + '&type=' + type">
    ...
    <div class="left">
      <template v-for="item, index in indexResult.newest_best_picks_list.slice(1, 4)">
        <a class="left_item" :href="'detailsBestpicks.html?id=' + item.id + '&type=' + type">
          <div class="left_item_text-group_1 flex-col ">
            <h2 class="text_21">
              {{item.title}}
            </h2>
  ...
  <div class="bottom best_picks_bottom">
    <a class="bottom_item" v-for="item in indexResult.newest_best_picks_list.slice(1, 4)" :href="'detailsBestpicks.html?id=' + item.id + '&type=' + type">
      <img class="image_2" referrerpolicy="no-referrer" :src="item.first_picture" />
      <div class="bottom_item_text-group_1 flex-col ">
        <h2 class="text_21">
          {{item.title}}
  ...
  <div class="read_more">
    ...
    <span class="bottom_border"></span>
    <a :href="'./reviewsPage.html?id=1-19-1' + '&type=' + type"><span>view more▶</span></a>
  </div>
  <div class="bottom reviews_bottom">
    <a class="bottom_item" v-for="item in indexResult.newest_reviews_list.slice(0, 4)" :href="'detailsReviews.html?id=' + item.id + '&type=' + type">
      <img class="image_2" referrerpolicy="no-referrer" :src="item.first_picture" />
      <div class="bottom_item_text-group_1 flex-col ">
        <h2 class="text_21">
          {{item.title}}
