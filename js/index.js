...
window.onload = function () {
    ...
    watch: {
      searchKeys(value, old) {
        ...
        document.querySelector(SEARCH_RESULT).innerHTML = this.successSearchResult.map((item, index) => `
            ...
            <a href="${item.type == 1 ? './detailsBestpicks.html?id=' + item.id : './detailsReviews.html?id=' + item.id + '&type=' + type}" class="article_item" style="padding-bottom: 20px;margin-top: 20px; border-bottom: 1px solid #ccc; display: inline-block;width: 100%">
  ...
  <p class="text_23">
    <span class="start" style="display: inline_block"><span v-for="el in details_info.score">★</span><span
        v-for="el in 5" style="color:#ccc">★</span></span><span class="text_23"> By {{details_info.author_name}} published
            ...
            <div class="article_list">
              <a :href="'./detailsReviews.html?id=' + item.id + '&type=' + type" class="article_item" v-for="item in channelResult.slice(4)">
                ...
                <div class="article_item_text-group_1">
                  ...
                  <div class="start">
                   <span v-for="el in Number(item.score)">★</span><span v-for="el in 5" style="color:#ccc">★</span>
                  </div>
                  <div class="text_22">
                    {{item.main_title}}
                  </div>
